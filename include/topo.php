...
<html lang="pt-br">
    ...
    <body>	
	   ...
	   <div id="topo">
		 ...
		 <nav id="menu">
			<ul>
				<a href="../index2.php"><li>Início</li></a>
				<a href="#"><li>Usuário</a>
					<ul>
						<a href="../pagCad/cadAluFunProf.php"><li>Cadastro Usuário</li></a>
				...
				<a href="#"><li>Livro</a>	
					<ul>
						...
						<a href="../visualizar/visLivroCadastrado.php"><li>Livros Cadastrados</li></a>
					</ul>
					
				</li>	
				<a href="#"><li>Empréstimo</a>
					<ul>
						<a href="../pagCad/cadEmprestimo.php"><li>Cadastrar Empréstimo</li></a>
						<a href="../visualizar/visEmprestimoRealizado.php"><li>Visualizar Empréstimos</li></a>
					</ul>
				</li>
				<a href="#"><li>Administração</a>
					<ul>
			...
			<form action='' method='get' class="sair">
